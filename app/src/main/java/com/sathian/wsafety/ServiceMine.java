...
public class ServiceMine extends Service {
    ...
    public void onCreate() {
        ...
        ShakeDetector.create(this, () -> {
            ...
            String enum1 = sharedPreferences.getString("ENUM1", "NONE");
            ...
            if (!enum1.equalsIgnoreCase("NONE")) {
                manager.sendTextMessage(enum1, null, "EMERGENCY! I need help.\nMy current location is: " + myLocation + "\nPlease come quickly or call for help.", null, null);
            }

            if (!enum2.equalsIgnoreCase("NONE")) {
                manager.sendTextMessage(enum2, null, "EMERGENCY! I need help.\nMy current location is: " + myLocation + "\nPlease come quickly or call for help.", null, null);
            }

            if (!enum3.equalsIgnoreCase("NONE")) {
                manager.sendTextMessage(enum3, null, "EMERGENCY! I need help.\nMy current location is: " + myLocation + "\nPlease come quickly or call for help.", null, null);
            }
            ...
            if (intent.getAction().equalsIgnoreCase("STOP")) {
                ...
                if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                    ...
                    Notification notification = new Notification.Builder(this, "MYID")
                            ...
                            .setContentText("Shake Device to Send MSG")
